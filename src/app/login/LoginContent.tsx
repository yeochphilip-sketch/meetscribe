      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={!!isLoading}
            className="w-full flex items-center justify-center gap-3 bg-gray-800 text-white rounded-lg px-4 py-3 font-medium hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading === 'github' ? (
