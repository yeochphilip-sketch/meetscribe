...
function PricingSection() {
  const plans = [
    { name: "Free", price: "$0", period: "/month", description: "Perfect for trying out MeetScribe", features: ["5 meetings per month", "Basic AI summaries", "Action items extraction", "7-day history", "Email support"], cta: "Get started free", popular: false },
