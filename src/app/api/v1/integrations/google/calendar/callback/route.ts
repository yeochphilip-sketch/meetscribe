  ...
  try {
    ...
    const tokenResponse = await fetch(GOOGLE_TOKEN_URL, {
      ...
      body: new URLSearchParams({
        ...
        redirect_uri: `${process.env.NEXT_PUBLIC_URL}/api/v1/integrations/google/calendar/callback`,
    ...
    return NextResponse.redirect(`${process.env.NEXT_PUBLIC_URL}/integrations?connected=google_calendar`);
  } catch (error: any) {
