      ...
      <div className="max-w-md w-full">
        ...
        <form ref={formRef} className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-lg transition-all flex items-center justify-center gap-2"
          >
